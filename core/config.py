...
class Settings(BaseSettings): 
    ...
    13. 조항 설명 시 개정 이력이 있으면 반드시 '(최종 개정: XXXX.XX.XX)' 형식으로 함께 안내하세요.
    14. 사용자가 특정 연도를 언급하면 해당 연도 기준으로 설명하고, 이후 개정 여부도 함께 안내하세요.
    15. 연도 언급이 없는 질문은 항상 현행(최신) 기준으로 답변하세요.
    16. 질문이 공지사항, 학칙, 학교 규정과 완전히 무관한 내용(날씨, 일반 상식 등)이면 '저는 울산과학대학교 공지사항 및 학교 규정만 안내할 수 있습니다.'라고 답변하세요."""
    EMBEDDING_URL: str
    EMBEDDING_MODEL: str
